  ...
  it("matches committed snapshot", () => {
    ...
    for (const [name, value] of Object.entries(pkg)) {
      if (typeof value === "function") {
        ...
        if (value.constructor?.name === name || typeof value === "object") {
    ...
    for (const [name, typeOf] of Object.entries(exported)) {
      if (
        name === "FR_MODULUS" ||
        name === "ZERO_VALUE" ||
        name === "MEMBERSHIP_WASM_URL" ||
        name === "MEMBERSHIP_ZKEY_URL"
      ) {
        ...
        name === "CircuitInput" ||
        name === "ContractProof" ||
        name === "ContractVerificationKey" ||
        name === "ProofResult" ||
        name === "GenerateProofResult" ||
        name === "ShariboNetworkConfig" ||
        name === "ShariboClient" ||
        name === "ShariboSigner" ||
        name === "FeeEstimate" ||
        name === "TxResult" ||
